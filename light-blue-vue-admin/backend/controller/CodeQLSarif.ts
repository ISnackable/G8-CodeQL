...
const file = fs.readFileSync("./sarifTestFiles/RMerl_asuswrt-merlin__2021-05-20_17_18_36__export.sarif", 'utf8');
...
for (const result of results){
    ...
    console.log(`> result.codeFlows?.[0].threadFlows[0].locations: ${result.codeFlows?.[0].threadFlows[0].locations ?? "NOTHING"}`);

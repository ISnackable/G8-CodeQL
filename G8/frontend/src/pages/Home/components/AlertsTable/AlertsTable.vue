...
<script>
  export default {
    data() {
      return {
        fields: ['Alerts_Detected', 'Type', 'Count'],
        items: [
          { Alerts_Detected: 'file1.js', Type: 'Warning', Count: 1 },
          { Alerts_Detected: 'file2.js', Type: 'Warning', Count: 2 },
          { Alerts_Detected: 'file3.js', Type: 'Warning', Count: 2 },
          { Alerts_Detected: 'file4.js', Type: 'Warning', Count: 2 },
          { Alerts_Detected: 'file5.js', Type: 'Warning', Count: 2 },
          { Alerts_Detected: 'file6.js', Type: 'Warning', Count: 2 },
          { Alerts_Detected: 'file7.js', Type: 'Warning', Count: 3 }
        ],
        tableVariants: [
          'primary',
          'secondary',

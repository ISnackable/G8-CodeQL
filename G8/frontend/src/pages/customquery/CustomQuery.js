...
<span> Callback Query </span>
    ...
    return (
      ...
      <div style={{ float : 'right',  marginRight : "50px" , marginTop : "30px"}}>
        ...
        <article>
          <h1 className="h2" id="quick-start" style={{ marginLeft : '20px ', marginTop : '10px'}}>
            Custom Query{" "}
          </h1>
      ...
      <Row className="justify-content-md-center">
        ...
        <label style={{ marginBottom : '10px'}}> Type in the box below </label>
        ...
        <div style={{ float : 'left',  marginRight : "50px", marginLeft: '20px'}}>
          <Dropdown className="btn-toolbar">
            <Dropdown.Toggle
              as={Button}
              variant="primary"

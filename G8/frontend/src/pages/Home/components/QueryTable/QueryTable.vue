...
<script>
  export default {
    data() {
      return {
        fields: ['Index', 'Files_Affected'],
        items: [
          { Files_Affected: 'file1.js'},
          { Files_Affected: 'file2.js'},
          { Files_Affected: 'file3.js'},
          { Files_Affected: 'file4.js'},
          { Files_Affected: 'file5.js'},
          { Files_Affected: 'file6.js'},
          { Files_Affected: 'file7.js', Query_File_Name: 'test1.ql'}
        ],
        tableVariants: [
          'primary',
          'secondary',

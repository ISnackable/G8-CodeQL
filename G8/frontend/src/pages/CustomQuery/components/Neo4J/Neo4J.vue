...
Front end - File/Folder (Soruce Code) -> Back End 
Back end - CodeQL Scanner Result Sarif -> Stored in folder on backend
                                       -> Neo4j database

Front End - Query project id -> Back End -> Neo4j                       -> Backend-> Front End
                                         -> Stored in folder on backend -> Backend
...
<style src="./Neo4J.scss" lang="scss" />

<template>
  ...
  >
    <header class="logo">
      <router-link to="/app"><img src="@/assets/logo/transparent-logo.png" alt="logo" width="100" height="100"/></router-link>
    </header>
    ...
    <ul class="nav">
      <h5 class="navTitle"><h1>Help</h1></h5>
      <NavLink
...
<style src="./SidebarDocumentation.scss" lang="scss" scoped/>
